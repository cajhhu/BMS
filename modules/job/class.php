...
class Job {
   ...
   public function __construct($job_id) {
      ...
      $query = $db->prepare("SELECT * FROM Job WHERE job_id = :job_id;");
   ...
   public function getPOC() {
      return NULL; // "<a href=\"index.php?page=person&action=view&id=" . $this->job_poc->get_ID() . "\">" . $this->job_poc->get_Name()->name . "</a>";
   }
